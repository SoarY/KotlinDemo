package com.soarsy.ktdemo.mvvm.utlis
...
/**
 * NAME：YONG_
 * Created at: 2022/2/15 13
 * Describe:
 */
class SharedPref<T>(val context : Context,val name : String,val default : T) : ReadWriteProperty<Any?,T>{
